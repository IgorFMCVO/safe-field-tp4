...
extern int64_t sf_validate_response(const void *, uint32_t, uint32_t, uint32_t);
...
int main(void) {
 ...
 uint8_t response[]={0x5A,0xA5,5,0x10,0x12,0x34,0,0,0x20,0,0,0};
 response[11]=refcrc(response+2,9);
 CHECK(sf_validate_response(response,0x10,0x1234,0x2000)==0);
 response[11]^=1;CHECK(sf_validate_response(response,0x10,0x1234,0x2000)==-6);response[11]^=1;
 response[3]=0x11;response[11]=refcrc(response+2,9);CHECK(sf_validate_response(response,0x10,0x1234,0x2000)==-2);response[3]=0x10;response[11]=refcrc(response+2,9);
 response[5]^=1;response[11]=refcrc(response+2,9);CHECK(sf_validate_response(response,0x10,0x1234,0x2000)==-3);response[5]^=1;response[11]=refcrc(response+2,9);
 response[9]^=1;response[11]=refcrc(response+2,9);CHECK(sf_validate_response(response,0x10,0x1234,0x2000)==-4);response[9]^=1;response[11]=refcrc(response+2,9);
 response[10]=0x80;response[11]=refcrc(response+2,9);CHECK(sf_validate_response(response,0x10,0x1234,0x2000)==-5);response[10]=0;response[11]=refcrc(response+2,9);
